<script>
    ...
    let validate = values => {
        ...
        if (!/^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&-+=()])(?=\S+$).{8,}$/.test(values.password)) {
            errors.password = "Use 8 or more characters with a mix of lowercase, uppercase, numbers & symbols."
        }
        ...
        <div class="bg-white py-8 px-4 shadow-md sm:rounded-lg sm:px-10">
            ...
            <Form class="space-y-6">
                ...
                <p class="text-sm text-gray-500">
                    By signing up, I accept the Spicety <a href={$url("/terms")} class="text-red-500">Terms of Service</a> and acknowledge the
                    <a href={$url("/privacy")} class="text-red-500">Privacy Policy</a>.
                </p>
